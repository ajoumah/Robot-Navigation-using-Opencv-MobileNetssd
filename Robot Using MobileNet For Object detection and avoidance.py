...
!ls /content/drive/MyDrive/MobileNetSSD/MobileNetSSD_deploy.prototxt

# If the file exists, check its permissions
!ls -l ls /content/drive/MyDrive/MobileNetSSD/MobileNetSSD_deploy.prototxt

import cv2 # Computer vision library
import numpy as np # Scientific computing library
import imutils
# Make sure the video file is in the same directory as your code
filename = '/content/drive/MyDrive/resources/vid-trashSani.MOV'
file_size = (1920,1080) # Assumes 1920x1080 mp4

# We want to save the output to a video file
output_filename = '/content/drive/MyDrive/MobileNet/trash_sani_obj_detect_mobssd.mp4'
output_frames_per_second = 20.0

RESIZED_DIMENSIONS = (300, 300) # Dimensions that SSD was trained on.
IMG_NORM_RATIO = 0.007843 # In grayscale a pixel can range between 0 and 255
prototxt_path = "/content/drive/MyDrive/MobileNetSSD/MobileNetSSD_deploy.prototxt"
caffemodel_path = "/content/drive/MyDrive/MobileNetSSD/MobileNetSSD_deploy.caffemodel"

# Load the pre-trained neural network
neural_network = cv2.dnn.readNetFromCaffe(prototxt_path, caffemodel_path)
...
def main():
  ...
  while cap.isOpened():
    ...
    # Fix the typo: use cv2.ROTATE_90_CLOCKWISE directly
